import{i}from"./assets/scrollUp-6e554bfe.js";import{a as $}from"./assets/vendor-2bc536cc.js";const l=document.querySelector(".scrol-list"),a="BASKET",u=document.querySelector(".empty-yellow-cart"),d=document.querySelector(".scrollbar-container"),m=document.querySelector(".order-container"),p=document.querySelector(".quantity-in-cart"),y=document.querySelector(".quantity-in-cart-header"),v=document.querySelector(".cart-sum-span");let n=JSON.parse(localStorage.getItem(`${a}`));function g(){const r=n.reduce((e,o)=>e+o.price*o.amount,0).toFixed(2);v.textContent=`$${r}`}function f(t){if(!t||t.length===0){u.style.display="block",d.style.display="none",m.style.display="none";return}g();const r=t.map(e=>`<li class="scroll-item" id="${e._id}">
